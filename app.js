...
document.querySelector(".btn-roll").addEventListener("click", function() {
    if (gamePlaying) {
        ...
        // 1. A random number
        var dice = 1 + Math.floor(Math.random() * 6); // generating random number between 1 and 6
...
function init () {
    ...
    document.querySelector(".dice").style.display = "none"; // selecting the dice image by accessing the CSS properties (style, display)
